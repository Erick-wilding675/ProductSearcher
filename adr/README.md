...
Registro das decisões arquiteturais do ProductSearcher. Cada ADR documenta **contexto, decisão, benefícios, consequências, alternativas descartadas** e **caminho de evolução / gatilho de revisão**.
...
| [0008](0008-cobertura-do-seed-parser-e-specs-opcionais.md) | Cobertura do seed: parser de título e specs opcionais | Aceito |
